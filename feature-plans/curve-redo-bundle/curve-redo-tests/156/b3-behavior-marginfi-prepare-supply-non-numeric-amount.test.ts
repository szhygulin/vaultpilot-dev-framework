...
test("prepare_marginfi_supply rejects a non-numeric amount", async () => {
  ...
  let failed = false;
  try {
    const r = await fn({ symbol: "USDC", amount: "not-a-number", owner: "11111111111111111111111111111112" });
