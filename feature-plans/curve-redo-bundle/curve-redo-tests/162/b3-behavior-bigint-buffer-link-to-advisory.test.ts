...
test("advisory tracking doc links to github.com/advisories or npmjs bigint-buffer page", () => {
  const text = collectAdvisoryDocs();
  expect(text).toMatch(/github\.com\/advisories|npmjs\.com\/package\/bigint-buffer/);
});
