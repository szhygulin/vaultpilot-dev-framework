...
test("inline 'Dependencies' without trailing colon does not trigger inline match", () => {
  const parse = getParser();
  const body = "This issue has Dependencies covered already and we mention #100 in passing.\n";
