...
test("live target-repo CLAUDE.md keeps its version when heading overlaps global", async () => {
  ...
  try {
    ...
    assert.ok(
      result.includes("LIVE_PR_BODY_bb"),
      "live CLAUDE.md must keep its version of the heading",
    );
  } finally {
