...
test("findDroppedInvariants: rewrite that preserves all #NNN refs emits no xref warning", () => {
  const md = fakeMd([
    { run: "run-A", issue: 100, heading: "Rule A", body: "Established in #137 after the long regression analysis. See also." },
  ]);
      ...
      rewrites: [
        {
          ...
          rewrittenBody: "Established in #137 after regression. See also.",
