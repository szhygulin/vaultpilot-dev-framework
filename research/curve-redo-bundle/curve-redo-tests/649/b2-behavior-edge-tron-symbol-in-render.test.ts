...
describe("Edge: TRON cost preview renders TRX symbol", () => {
  it("rendered output for TRON fee mentions TRX", async () => {
    const out = await tryRender({ feeNative: "5", chain: "TRX", usd: 0.1 });
